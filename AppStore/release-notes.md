...
- Rechecks the exact catalog identity, revision, game build, every canonical part decision, and local-use evidence before offering reuse.
- Carries only part availability into a new capability-only snapshot, restoring exact alternative purchase paths without unlocking tuning-menu facts or numeric settings.
